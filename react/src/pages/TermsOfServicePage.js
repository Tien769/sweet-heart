...
const Terms = () => {
  return (
    <div>
      <div>
        <h2 className={`${styles.sectionHeading}`}>1. ĐIỀU KHOẢN DỊCH VỤ</h2>
        <hr />
      </div>
      {/*BODY*/}
      <div className={styles.helpBody}>
        <div>
          <h3>GIỚI THIỆU</h3>
          <p>Điều khoản dịch vụ này là một phần không thể tách rời của sweet heart.</p>
          <ul>
            <li>
              Chào mừng bạn đến với sweet heart qua giao diện website. Trước khi sử dụng Trang hoặc
              tạo tài khoản sweet heart (“Tài Khoản”), vui lòng đọc kỹ các Điều Khoản Dịch Vụ dưới
              đây để hiểu rõ quyền lợi và nghĩa vụ hợp pháp của mình đối với chúng tôi (sweet
              heart). Nếu có bất kỳ tính năng mới nào được bổ sung hoặc mở rộng đối với dịch vụ đều
            ...
            <li>
              Sweet heart bảo lưu quyền từ chối yêu cầu mở Tài Khoản hoặc các truy cập của bạn tới
...
const Security = () => {
  return (
    <div>
      <div>
        <h2 className={styles.sectionHeading}>2. CHÍNH SÁCH BẢO MẬT</h2>
        <hr />
      </div>
      <div className={styles.helpBody}>
        <div>
          ...
          <p>
            Trên đây chỉ là một số trường hợp phổ biến mà chúng tôi thu thập dữ liệu cá nhân của
            bạn, không phản ánh hết toàn bộ các trường hợp mà chúng tôi sẽ thu thập dữ liệu cá nhân
            của bạn.
          </p>
        </div>
        <div>
          <h3>SHOP SẼ THU THẬP NHỮNG DỮ LIỆU GÌ?</h3>
          <p>Dữ liệu cá nhân mà Shop có thể thu thập bao gồm, nhưng không giới hạn:</p>
          <ol>
            <li>Họ tên.</li>
...
export { Page as TermsOfServicePage };
