                ...
                <div className='col-md-3 col-sm-6'>
                  ...
                  <div className='footer-pad'>
                    ...
                    <ul className='list-unstyled'>
                      ...
                      <li>
                        <a href='#'>VỀ SWEET HEART</a>
                      </li>
                      <li>
                        <a href='#'>HƯỚNNG DẪN ĐẶT HÀNG</a>
                      </li>
                      <li>
                        <a href='#'>LIÊN HỆ</a>
                      </li>
                ...
                <div className='col-md-3 col-sm-6'>
                  ...
                  <div className='footer-pad'>
                    ...
                    <ul className='list-unstyled'>
                      ...
                      <li>
                        <a href='#'>TƯ VẤN THẮC MẮC (9:00 - 18:00)</a>
                      </li>
                      <li>
                        <a href='#'>- (028) 1111 2222 </a>
                      </li>
                      <li>
                        <a href='#'>- (028) 3333 4444</a>
                      </li>
                      <li>
                        <a href='#'>GÓP Ý, KHIẾU NẠI (9:00 - 18:00)</a>
                      </li>
                      <li>
                        <a href='#'>- (028) 1111 2222</a>
                      </li>
