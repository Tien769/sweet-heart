        ...
        <div className="help">
            ...
            <div className="help-body">
                <div className="body-1">
                    <h3>GIỚI THIỆU</h3>
                    <p>
                        Điều khoản dịch vụ này là một phần không thể tách rời của sweet heart. 
                    </p>
                    <ul>
                        <li className="thut">
                            Chào mừng bạn đến với sweet heart qua giao diện website. Trước khi sử dụng Trang hoặc tạo tài khoản sweet heart (“Tài Khoản”), 
                            vui lòng đọc kỹ các Điều Khoản Dịch Vụ dưới đây để hiểu rõ quyền lợi và nghĩa vụ hợp pháp của mình đối với chúng tôi (sweet heart). 
                            Nếu có bất kỳ tính năng mới nào được bổ sung hoặc mở rộng đối với dịch vụ đều thuộc phạm vi điều chỉnh của điều khoản dịch vụ 
                            này. Điều Khoản dịch vụ này điều chỉnh việc bạn sử dụng dịch vụ cung cấp bởi chúng tôi. 
                        </li>
                        <li className="thut"> 
                            Dịch Vụ bao gồm dịch vụ sàn giao dịch trực tuyến kết nối người tiêu dùng với nhau nhằm mang đến cơ hội kinh doanh giữa người 
                            mua (“Người Mua”) và người bán (“Người Bán”) (gọi chung là “bạn”, “Người Sử Dụng” hoặc “Các Bên”). Hợp đồng mua bán thật sự là 
                            trực tiếp giữa Người Mua và Người Bán. Các Bên liên quan đến giao dịch sẽ hoàn toàn chịu trách nhiệm đối với hợp đồng mua bán.
                        </li>
                        <li className="thut">
                            Trước khi trở thành Người Sử Dụng của Trang web, bạn cần đọc và chấp nhận mọi điều khoản và điều kiện được quy định trong, và 
                            dẫn chiếu đến, Điều Khoản Dịch Vụ này và Chính Sách Bảo Mật được dẫn chiếu theo đây. 
                        </li>
                        <li className="thut">
                            Chúng tôi bảo lưu quyền thay đổi, chỉnh sửa, tạm ngưng hoặc chấm dứt tất cả hoặc bất kỳ phần nào của Trang web hoặc Dịch Vụ vào 
                            bất cứ thời điểm nào theo qui định pháp luật. Chúng tôi có toàn quyền giới hạn một số tính năng hoặc phạm vi truy cập của bạn đối với 
                            một phần hoặc toàn bộ Trang web hoặc Dịch Vụ của Shopee mà không cần thông báo hay chịu trách nhiệm.
                        </li>
                        <li className="thut">
                            Sweet heart bảo lưu quyền từ chối yêu cầu mở Tài Khoản hoặc các truy cập của bạn tới Trang web hoặc Dịch Vụ với bất kỳ lý do nào.
                        </li>
                    </ul>
                </div>
                <div className="body-2">
                    ...
                    <p>
                        Chúng tôi coi trọng việc bảo mật thông tin của bạn. Để bảo vệ quyền lợi người dùng, Shop cung cấp Chính Sách Bảo Mật để giải thích chi tiết các hoạt động bảo mật của chúng tôi. Vui lòng tham khảo Chính Sách Bảo Mật để biết cách thức Shop thu thập và sử dụng thông tin liên quan đến Tài Khoản và/hoặc việc sử dụng Dịch Vụ của Người Sử Dụng (“Thông Tin Người Sử Dụng”). Điều Khoản Dịch Vụ này có liên quan mật thiết với Chính Sách Bảo Mật. Bằng cách sử dụng Dịch Vụ hoặc cung xấp thông tin trên Trang web, Người Sử Dụng: 
                    </p>
                    <ul>
                        <li className="thut">
                            Cho phép Shop thu thập, sử dụng, công bố và/hoặc xử lý các Nội Dung, dữ liệu cá nhân của bạn và Thông Tin Người Sử Dụng như được quy định trong Chính Sách Bảo Mật. 
                        </li>
                        <li className="thut"> 
                            Đồng ý và công nhận rằng, trong phạm vi pháp luật có liên quan cho phép, các Thông Tin Người Sử Dụng sẽ thuộc sở hữu chung của bạn và Shop.
                        </li>
                        <li className="thut">
